...
# from slowfast.models.timesformer.vit_utils import DropPath
...
class MultiScaleAttention(nn.Module):
    ...
    def forward(self, x, thw_shape):
        ...
        attn_out = torch.zeros(1) #if self.training else attn.detach().cpu()
        return x, q_shape, attn_out
...
class MultiScaleBlock(nn.Module):
    ...
    def forward(self, x, thw_shape):
        x_block, thw_shape_new, attn = self.attn(self.norm1(x), thw_shape)
...
# Insert implementation stuff from timeSformer
...
class Block(nn.Module):
    ...
    def __init__(self, dim, num_heads, mlp_ratio=4., qkv_bias=False, qk_scale=None, drop=0., attn_drop=0.,
        ...
        self.norm2 = norm_layer(dim)
        mlp_hidden_dim = int(dim * mlp_ratio)
        self.mlp = MlpT(in_features=dim, hidden_features=mlp_hidden_dim, act_layer=act_layer, drop=drop)
