...
class BasicTransform(nn.Module):
    ...
    def __init__(
        ...
        assert dilation == 1, 'dilation != 1 not implemented for BasicTransform.'
...
class TimeFreqBottleneckTransform_v1(nn.Module):
    ...
    def _construct(self, dim_in, dim_out, stride, dim_inner, num_groups, 
        ...
        if self._stride_1x1:
            str1x1_h, str1x1_w = stride_h, stride_w
            str3x3_h, str3x3_w = 1, 1
        else:
            str1x1_h, str1x1_w = 1, 1
            str3x3_h, str3x3_w = stride_h, stride_w
...
class TimeFreqBottleneckTransform_v2(nn.Module):
    ...
    def _construct(self, dim_in, dim_out, stride, dim_inner, num_groups, 
        ...
        if isinstance(dilation, int):
            dilation_t, dilation_h, dilation_w = dilation, dilation, dilation
        else:
            dilation_t, dilation_h, dilation_w = dilation
        ...
        self.a = nn.Conv3d(
            ...
            stride=[1, str1x1_h, str1x1_w],
            padding=[dilation_t * int(self.temp_kernel_size // 2), 0, 0],
            bias=False,
        ...
        self.b_t = nn.Conv3d(
            ...
            [1, 3, 1],
            stride=[1, str3x3_h, str3x3_w],
            padding=[0, dilation_h, 0],
            groups=num_groups,
            bias=False,
            dilation=[1, dilation_h, 1],
        )
        ...
        self.b_f = nn.Conv3d(
            ...
            [1, 1, 3],
            stride=[1, str3x3_h, str3x3_w],
            padding=[0, 0, dilation_w],
            groups=num_groups,
            bias=False,
            dilation=[1, 1, dilation_w],
        )
...
class BottleneckTransform(nn.Module):
    ...
    def _construct(
        ...
        self.b = nn.Conv3d(
            ...
            [1, 3, 3],
            stride=[1, str3x3_h, str3x3_w],
            padding=[0, dilation_h, dilation_w],
            groups=num_groups,
            bias=False,
